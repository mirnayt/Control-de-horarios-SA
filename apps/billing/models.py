...
class LineaCobro(TimeStampedModel):
    ...
    Unique (periodo, concepto) → el job de recargo es idempotente.
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            ...
            prev = LineaCobro.objects.filter(pk=self.pk).values(
                ...
                "monto", "reglas_aplicadas", "concepto", "periodo_id", "parametro_version_id"
            ...
            if prev and (
                ...
                raise ValidationError(
                    ...
                    "LineaCobro es inmutable en monto, reglas, concepto y periodo."
